...
export function AddToPlaylistDialog({ track, onClose, onSuccess }: AddToPlaylistDialogProps) {
  const titleId = useId();
  ...
  return (
    ...
    >
      <div
        className="card flex max-h-[min(85vh,720px)] w-full max-w-lg flex-col overflow-hidden"
